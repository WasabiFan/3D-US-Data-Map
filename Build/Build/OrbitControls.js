...
THREE.OrbitAndPanControls = function ( object, domElement ) {
	...
	function onMouseMove( event ) {
		...
		if ( state === STATE.ROTATE ) {
			...
			scope.rotateLeft( 2 * Math.PI * rotateDelta.x / scope.domElement.scrollWidth * scope.userRotateSpeed );
			scope.rotateUp( Math.PI * rotateDelta.y / scope.domElement.scrollHeight * scope.userRotateSpeed );
			...
			scope.panLeft( 2 * panDelta.x * targetDistance / scope.domElement.scrollHeight );
			scope.panUp( 2 * panDelta.y * targetDistance / scope.domElement.scrollHeight );
